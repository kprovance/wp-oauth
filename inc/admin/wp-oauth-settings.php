...
function wpoa_cc_security() {
	...
	if ( '1' === get_option( 'wpoa_hide_wordpress_login_form' ) ) {
		$points ++;
	}
	...
	if ( '1' === get_option( 'wpoa_http_util_verify_ssl' ) ) {
		$points ++;
	}

	if ( 'curl' === get_option( 'wpoa_http_util' ) ) {
		$points ++;
	}
...
function wpoa_cc_ux() {
	...
	if ( '1' === get_option( 'wpoa_logo_links_to_site' ) ) {
		$points ++;
	}

	if ( '1' === get_option( 'wpoa_show_login_messages' ) ) {
		$points ++;
	}
...
<div class='wrap wpoa-settings'>
	<div id="wpoa-settings-meta">Toggle tips:
		<ul>
			<li><a id="wpoa-settings-tips-on" href="#">On</a></li>
			<li><a id="wpoa-settings-tips-off" href="#">Off</a></li>
		</ul>
		<div class="nav-splitter"></div>
		Toggle sections:
		<ul>
			<li><a id="wpoa-settings-sections-on" href="#">On</a></li>
			<li><a id="wpoa-settings-sections-off" href="#">Off</a></li>
		</ul>
	</div>
		...
		<div id="wpoa-settings-col2" class="wpoa-settings-column">
			<div id="wpoa-settings-section-about" class="wpoa-settings-section">
				...
				<div class='form-padding'>
					...
					<p>Rate it 5 stars:
						<a
							id="wpoa-rate-5stars"
							href="https://wordpress.org/support/view/plugin-reviews/wp-oauth?rate=5"
							target="_blank">
							<img src="http://ps.w.org/wp-oauth/assets/5stars.png" style="vertical-align:text-top;"></img>
						</a>
					</p>
					<nav>
						<ul>
							<li><a href="https://wordpress.org/plugins/wp-oauth/" target="_blank">WP-OAuth at
									WordPress.org</a></li>
							<li><a href="https://github.com/perrybutler/WP-OAuth" target="_blank">WP-OAuth at
									GitHub.com</a></li>
							<li><a href="http://glassocean.net/wp-oauth-enhances-your-wordpress-login-and-registration/" target="_blank">WP-OAuth at GlassOcean.net</a></li>
						</ul>
					</nav>
				</div>
			</div>
			<div id="wpoa-settings-section-news" class="wpoa-settings-section">
				...
				<div class='form-padding'>
					...
					?>
					<?php if ( 0 === $maxitems ) { ?>
						<p><?php esc_html_e( 'Sorry, news was inaccessible or does not exist.', 'wp-oauth' ); ?></p>
					<?php } else { ?>
						<ul>
							<?php foreach ( $rss_items as $item ) : ?>
								<li>
									<a
										...
										title="<?php printf( esc_attr__( 'Posted %s', 'wp-oauth' ), esc_html( $item->get_date( 'j F Y | g:i a' ) ) ); ?>"
										target="_blank">
			...
			<div id="wpoa-settings-section-config-check" class="wpoa-settings-section">
				...
				<div class='form-padding'>
					...
					<div id='wpoa-measurements'>
						<div class="has-tip">
							<div class="wpoa-measurement-label">Security: <?php echo intval( $cc_security ); ?>%
								<a href="#" class="tip-button">[?]</a>
							</div>
							<div class="wpoa-measurement">
								<div class="wpoa-measurement-rating" style="width:<?php echo intval( $cc_security ); ?>%;"></div>
							</div>
							<p class="tip-message">
						...
						<div class="has-tip">
							<div class="wpoa-measurement-label">Privacy: <?php echo intval( $cc_privacy ); ?>%
								<a href="#" class="tip-button">[?]</a>
							</div>
							<div class="wpoa-measurement">
								<div class="wpoa-measurement-rating" style="width:<?php echo intval( $cc_privacy ); ?>%;"></div>
							</div>
							<p class="tip-message">
								+1 if Automatically logout inactive users = True<br/>
							</p>
						...
						<div class="has-tip">
							<div class="wpoa-measurement-label">User Experience: <?php echo intval( $cc_ux ); ?>% <a href="#" class="tip-button">[?]</a>
							</div>
							<div class="wpoa-measurement">
								<div class="wpoa-measurement-rating" style="width:<?php echo intval( $cc_ux ); ?>%;"></div>
							</div>
							<p class="tip-message">
			...
			<div id="wpoa-settings-section-donate" class="wpoa-settings-section">
				...
				<div class='form-padding'>
					...
					<p>WP-OAuth remains free of restrictions, advertisements, branding, etc. <em>Your donations help
							make this possible.</em></p>
			...
			<div id="wpoa-settings-section-support" class="wpoa-settings-section">
				...
				<div class='form-padding'>
					<p>Your general questions can be asked in the plugin <a
								href="https://wordpress.org/support/plugin/wp-oauth" target="_blank">support forum</a>.
					</p>
				</div>
			</div>
		</div>
			...
			<form method='post' action='options.php'>
						...
						<table class='form-table'>
							<tr valign='top' id='has-tip' class="has-tip">
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_show_login_messages'
										value='1' <?php checked( '1' === get_option( 'wpoa_show_login_messages' ) ); ?>
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<select name='wpoa_login_redirect'>
										<option value='home_page' <?php selected( get_option( 'wpoa_login_redirect' ), 'home_page' ); ?>>
											Home Page
										</option>
										<option value='last_page' <?php selected( get_option( 'wpoa_login_redirect' ), 'last_page' ); ?>>
											Last Page
										</option>
										<option value='specific_page' <?php selected( get_option( 'wpoa_login_redirect' ), 'specific_page' ); ?>>
											Specific Page
										</option>
										<option value='admin_dashboard' <?php selected( get_option( 'wpoa_login_redirect' ), 'admin_dashboard' ); ?>>
											Admin Dashboard
										</option>
										<option value='user_profile' <?php selected( get_option( 'wpoa_login_redirect' ), 'user_profile' ); ?>>
											User's Profile Page
										</option>
										<option value='custom_url' <?php selected( get_option( 'wpoa_login_redirect' ), 'custom_url' ); ?>>
											Custom URL
										</option>
									</select>
									<?php
									wp_dropdown_pages(
										array(
											'id'       => 'wpoa_login_redirect_page',
											'name'     => 'wpoa_login_redirect_page',
											'selected' => esc_html( get_option( 'wpoa_login_redirect_page' ) ),
										)
									);
									?>
									<input
										type="text"
										name="wpoa_login_redirect_url"
										value="<?php echo esc_html( get_option( 'wpoa_login_redirect_url' ) ); ?>"
										style="display:none;"
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<select name='wpoa_logout_redirect'>
										<option value='default_handling' <?php selected( get_option( 'wpoa_logout_redirect' ), 'default_handling' ); ?>>
											Let WordPress handle it
										</option>
										<option value='home_page' <?php selected( get_option( 'wpoa_logout_redirect' ), 'home_page' ); ?>>
											Home Page
										</option>
										<option value='last_page' <?php selected( get_option( 'wpoa_logout_redirect' ), 'last_page' ); ?>>
											Last Page
										</option>
										<option value='specific_page' <?php selected( get_option( 'wpoa_logout_redirect' ), 'specific_page' ); ?>>
											Specific Page
										</option>
										<option value='admin_dashboard' <?php selected( get_option( 'wpoa_logout_redirect' ), 'admin_dashboard' ); ?>>
											Admin Dashboard
										</option>
										<option value='user_profile' <?php selected( get_option( 'wpoa_logout_redirect' ), 'user_profile' ); ?>>
											User's Profile Page
										</option>
										<option value='custom_url' <?php selected( get_option( 'wpoa_logout_redirect' ), 'custom_url' ); ?>>
											Custom URL
										</option>
									</select>
									<?php
									wp_dropdown_pages(
										array(
											'id'       => 'wpoa_logout_redirect_page',
											'name'     => 'wpoa_logout_redirect_page',
											'selected' => esc_html( get_option( 'wpoa_logout_redirect_page' ) ),
										)
									);
									?>
									<input
										type="text"
										name="wpoa_logout_redirect_url"
										value="<?php echo esc_attr( get_option( 'wpoa_logout_redirect_url' ) ); ?>"
										style="display:none;"
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<select name='wpoa_logout_inactive_users'>
										<option value='0' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '0' ); ?>>
											Never
										</option>
										<option value='1' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '1' ); ?>>
											After 1 minute
										</option>
										<option value='5' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '5' ); ?>>
											After 5 minutes
										</option>
										<option value='15' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '15' ); ?>>
											After 15 minutes
										</option>
										<option value='30' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '30' ); ?>>
											After 30 minutes
										</option>
										<option value='60' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '60' ); ?>>
											After 1 hour
										</option>
										<option value='120' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '120' ); ?>>
											After 2 hours
										</option>
										<option value='240' <?php selected( get_option( 'wpoa_logout_inactive_users' ), '240' ); ?>>
											After 4 hours
										</option>
									</select>
						...
						<table class='form-table'>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_hide_wordpress_login_form'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_hide_wordpress_login_form' ) ); ?>
									/>
									<p class="tip-message">Use this to hide the WordPress username/password login form
										that is shown by default on the Login Screen and Login Popup.
									</p>
									<p class="tip-message tip-warning"><strong>Warning: </strong>Hiding the WordPress
										...
										login provider(s) are active and working BEFORE enabling this setting.
									</p>
								</td>
							</tr>
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_logo_links_to_site'
										value='1' <?php checked( '1' === get_option( 'wpoa_logo_links_to_site' ) ); ?>
									/>
								...
								<td>
									<p>
										<input
											...
											type='text'
											size=''
											name='wpoa_logo_image'
											value="<?php echo esc_attr( get_option( 'wpoa_logo_image' ) ); ?>"
										/>
								...
								<td>
									<p>
										<input
											...
											size=''
											name='wpoa_bg_image'
											value="<?php echo esc_attr( get_option( 'wpoa_bg_image' ) ); ?>"
										/>
							...
							<tr valign='top' class="has-tip">
								<th scope='row'>Custom form to show on the user's profile page:
									<a href="#" class="tip-button">[?]</a>
								</th>
								<td>
							...
							<tr valign='top' class="has-tip">
								<th scope='row'>Custom form to show in the comments section:
									<a href="#" class="tip-button">[?]</a>
								</th>
								<td>
				...
				<div id="wpoa-settings-section-custom-login-form-designs" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						...
						<pre><code>[wpoa_login_form design='CustomDesign1']</code></pre>
						<table class='form-table'>
							<tr valign='top' class="has-tip">
								...
								<td>
									...
									<p class="tip-message tip-info"><strong>Tip: </strong>Make sure to click the <em>Save
											all settings</em> button after making changes here.
									</p>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<table class="form-table" id="wpoa-login-form-design-form">
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										id='wpoa-login-form-design-name'
										type='text'
										size='36'
										name='wpoa_login_form_design_name' value=""
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										id='wpoa_login_form_button_prefix'
										type='text'
										size='36'
										name='wpoa_login_form_button_prefix' value=""
									/>
									<p class="tip-message">Sets the text prefix to be displayed on the social login buttons.
									</p>
								</td>
							</tr>
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										id='wpoa_login_form_logged_out_title'
										type='text'
										size='36'
										name='wpoa_login_form_logged_out_title' value=""
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										id='wpoa_login_form_logged_in_title'
										type='text'
										size='36'
										name='wpoa_login_form_logged_in_title' value=""
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										id='wpoa_login_form_logging_in_title'
										type='text'
										size='36'
										name='wpoa_login_form_logging_in_title' value=""
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										id='wpoa_login_form_logging_out_title'
										type='text'
										size='36'
										name='wpoa_login_form_logging_out_title' value=""
									/>
							...
							<tr valign='top' id='wpoa-login-form-actions'>
								<th scope='row'>
									<input
										type="button"
										id="wpoa-login-form-ok"
										name="wpoa_login_form_ok"
										class="button" value="OK"
									/>
									<input
										type="button"
										id="wpoa-login-form-cancel"
										name="wpoa_login_form_cancel"
						...
						<table class='form-table'>
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_suppress_welcome_email'
										value='1' <?php checked( '1' === get_option( 'wpoa_suppress_welcome_email' ) ); ?>
									/>
				...
				<div id="wpoa-settings-section-login-with-google" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_google_api_enabled'
										value='1' <?php checked( '1' === get_option( 'wpoa_google_api_enabled' ) ); ?>
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_google_api_id'
										value='<?php echo esc_html( get_option( 'wpoa_google_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_google_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_google_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							...
							<li>At Google, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the new
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								<th scope='row'>Enabled:</th>
								<td>
									<input type='checkbox' name='wpoa_slack_api_enabled' value='1' <?php checked( '1' === get_option( 'wpoa_slack_api_enabled' ) ); ?> />
								</td>
							</tr>
							...
							<tr valign='top'>
								<th scope='row'>Client ID:</th>
								<td>
									<input type='text' name='wpoa_slack_api_id' value='<?php echo esc_attr( get_option( 'wpoa_slack_api_id' ) ); ?>' />
								</td>
							</tr>
							...
							<tr valign='top'>
								<th scope='row'>Client Secret:</th>
								<td>
									<input type='text' name='wpoa_slack_api_secret' value='<?php echo esc_attr( get_option( 'wpoa_slack_api_secret' ) ); ?>' />
								</td>
							</tr>
						</table> <!-- .form-table -->
						<p>
						...
						<ol>
							<li>Visit  <a href='https://api.slack.com/apps' target="_blank">https://api.slack.com/slack-apps</a>.</li>
							<li>Click Create a Slack app.</li>
							<li>Enter the app name and Slack Wordspace.</li>
							<li>Paste your Client ID/Secret provided by Slack into the fields above, then click the Save all settings button.</li>
						</ol>
						<?php submit_button( 'Save all settings' ); ?>
					</div> <!-- .form-padding -->
				</div> <!-- .wpoa-settings-section -->
				...
				<!-- START Login with Envato section -->
				<div id="wpoa-settings-section-login-with-envato" class="wpoa-settings-section">
					<h3>Login with Envato</h3>
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								<th scope='row'>Enabled:</th>
								<td>
									<input
										type='checkbox'
										name='wpoa_envato_api_enabled'
										value='1'
										<?php checked( get_option( 'wpoa_envato_api_enabled' ) === '1' ); ?>
									/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_envato_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_envato_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_envato_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_envato_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							<li>Visit the Envato website for developers <a
				...
				<div id="wpoa-settings-section-login-with-facebook" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_facebook_api_enabled'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_facebook_api_enabled' ) ); ?>
									/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_facebook_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_facebook_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_facebook_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_facebook_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							<li>Register as a Facebook Developer at
							...
							<li>At Facebook, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the new
...
<!--
				...
				<div id="wpoa-settings-section-login-with-linkedin" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_linkedin_api_enabled'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_linkedin_api_enabled' ) ); ?>
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_linkedin_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_linkedin_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_linkedin_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_linkedin_api_secret' ) ); ?>'/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						<p>
						...
						<ol>
							<li>Register as a LinkedIn Developer at
								<a href='https://developers.linkedin.com/' target="_blank">developers.linkedin.com</a>.
							</li>
							<li>At LinkedIn, create a new App. This will enable your site to access the LinkedIn API.
							</li>
							<li>At LinkedIn, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the new
								App's Redirect URI. Don't forget the trailing slash!
							</li>
				...
				<div id="wpoa-settings-section-login-with-github" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_github_api_enabled'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_github_api_enabled' ) ); ?>
									/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_github_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_github_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_github_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_github_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							<li>Register as a Github Developer at
								<a href='https://developers.github.com/' target="_blank">developers.github.com</a>.
							</li>
							<li>At Github, create a new App. This will enable your site to access the Github API.</li>
							<li>At Github, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the new App's
								Redirect URI. Don't forget the trailing slash!
							</li>
							<li>Paste your API Key/Secret provided by Github into the fields above, then click the Save
								all settings button.
							</li>
						</ol>
						<?php submit_button( 'Save all settings' ); ?>
				...
				<div id="wpoa-settings-section-login-with-reddit" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_reddit_api_enabled'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_reddit_api_enabled' ) ); ?>
									/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_reddit_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_reddit_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_reddit_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_reddit_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							<li>Register as a Reddit Developer at
								<a href='https://ssl.reddit.com/prefs/apps' target="_blank">ssl.reddit.com/prefs/apps</a>.
							</li>
							<li>At Reddit, create a new App. This will enable your site to access the Reddit API.</li>
							<li>At Reddit, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the new App's
								Redirect URI. Don't forget the trailing slash!
							</li>
							<li>Paste your Client ID/Secret provided by Reddit into the fields above, then click the
								Save all settings button.
							</li>
						</ol>
						<?php submit_button( 'Save all settings' ); ?>
				...
				<div id="wpoa-settings-section-login-with-windowslive" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_windowslive_api_enabled'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_windowslive_api_enabled' ) ); ?> />
								</td>
							</tr>
							<tr valign='top'>
								<th scope='row'>Client ID:</th>
								<td>
									<input
										type='text'
										name='wpoa_windowslive_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_windowslive_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_windowslive_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_windowslive_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							<li>Register as a Windows Live Developer at
								<a href='https://manage.dev.live.com' target="_blank">manage.dev.live.com</a>.
							</li>
							<li>At Windows Live, create a new App. This will enable your site to access the Windows Live
								API.
							</li>
							<li>At Windows Live, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the new
								App's Redirect URI. Don't forget the trailing slash!
							</li>
							<li>Paste your Client ID/Secret provided by Windows Live into the fields above, then click
				...
				<div id="wpoa-settings-section-login-with-paypal" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_paypal_api_enabled'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_paypal_api_enabled' ) ); ?>
									/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_paypal_api_sandbox_mode'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_paypal_api_sandbox_mode' ) ); ?>
									/>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_paypal_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_paypal_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_paypal_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_paypal_api_secret' ) ); ?>'/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						<p>
						...
						<ol>
							<li>Register as a PayPal Developer at
							...
							<li>At PayPal, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the <em>App
				...
				<div id="wpoa-settings-section-login-with-instagram" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_instagram_api_enabled'
										value='1'
										<?php checked( get_option( 'wpoa_instagram_api_enabled' ) === '1' ); ?>
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_instagram_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_instagram_api_id' ) ); ?>'/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_instagram_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_instagram_api_secret' ) ); ?>'/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						<p>
						...
						<ol>
							...
							<li>At Instagram, register as an
								<a href='http://instagram.com/developer/authentication/' target="_blank">Instagram Developer</a>.
							</li>
							...
							<li>At Instagram, provide your site's homepage URL (<?php echo esc_html( $blog_url ); ?>) for the <em>OAuth
						...
						<ul>
							<li>
								<a href='http://instagram.com/developer/authentication/'>Instagram Developer Reference - Authentication</a>
							</li>
						</ul>
						<?php submit_button( 'Save all settings' ); ?>
					</div> <!-- .form-padding -->
				...
				<div id="wpoa-settings-section-login-with-battlenet" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						<table class='form-table'>
							<tr valign='top'>
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_battlenet_api_enabled'
										value='1'
										<?php checked( get_option( 'wpoa_battlenet_api_enabled' ) === '1' ); ?>
									/>
								</td>
							</tr>
							...
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_battlenet_api_id'
										value='<?php echo esc_attr( get_option( 'wpoa_battlenet_api_id' ) ); ?>'
									/>
								</td>
							</tr>
							<tr valign='top'>
								...
								<td>
									<input
										type='text'
										name='wpoa_battlenet_api_secret'
										value='<?php echo esc_attr( get_option( 'wpoa_battlenet_api_secret' ) ); ?>'
									/>
								</td>
							</tr>
						</table> <!-- .form-table -->
						...
						<ol>
							<li>NOTE: Battle.net API <em>requires</em> your site to be secured with an SSL certificate;
								the site URL should start with <u>https://</u>.
							</li>
							<li>Visit the <a href='http://dev.battle.net/' target="_blank">Battle.net API</a> home page
								and <a href='https://dev.battle.net/member/register' target="_blank">Create a Mashery
									Account</a>.
							<li>After creating your account and signing in, visit the <a
										href='https://dev.battle.net/apps/myapps'>My Applications</a> page.
							</li>
							<li><a href="https://dev.battle.net/apps/register">Create a New Application</a> and fill out
								the details.
							</li>
							<li>Provide your site URL (<?php echo esc_url( site_url( '', 'https' ) ); ?>/) for the <em>Register
									Callback URL</em>. Don't forget the trailing slash!
							</li>
							<li>After registering the application, locate the <em>Key/Secret</em> provided by Battle.net
								and paste them into the fields above, then click the Save all settings button.
							</li>
						</ol>
						<strong>References:</strong>
						<ul>
							<li><a href='https://dev.battle.net/docs/read/oauth' target='_blank'>Battle.net OAuth
									Reference</a></li>
							<li><a href='https://dev.battle.net/apps/tos' target='_blank'>Battle.net API Terms of
									Service</a></li>
						</ul>
						<?php submit_button( 'Save all settings' ); ?>
					</div> <!-- .form-padding -->
				...
				<div id="wpoa-settings-section-back-channel=configuration" class="wpoa-settings-section">
					...
					<div class='form-padding'>
						...
						<table class='form-table'>
							<tr valign='top' class="has-tip">
								...
								<td>
									<select name='wpoa_http_util'>
										<option value='curl' <?php selected( get_option( 'wpoa_http_util' ), 'curl' ); ?>>
											cURL
										</option>
										<option value='stream-context' <?php selected( get_option( 'wpoa_http_util' ), 'stream-context' ); ?>>
											Stream Context
										</option>
									</select>
							...
							<tr valign='top' class="has-tip">
								<th scope='row'>Verify Peer/Host SSL Certificates:
									<a href="#" class="tip-button">[?]</a>
								</th>
								<td>
									<input
										type='checkbox'
										name='wpoa_http_util_verify_ssl'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_http_util_verify_ssl' ) ); ?>
									/>
						...
						<table class='form-table'>
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_restore_default_settings'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_restore_default_settings' ) ); ?>
									/>
							...
							<tr valign='top' class="has-tip">
								...
								<td>
									<input
										type='checkbox'
										name='wpoa_delete_settings_on_uninstall'
										value='1'
										<?php checked( '1' === get_option( 'wpoa_delete_settings_on_uninstall' ) ); ?>
									/>
									<p class="tip-message"><strong>Instructions:</strong> Check the box above, click the
